...
var popup = $timeout(function() {
    $scope.showPopup(); //close the popup after 3 seconds for some reason
   }, 3000);
...
.controller('meterCtrl', function($scope, $state, $ionicPopup, AuthService){


})

.controller('questionCtrl', function($scope, $state, $ionicPopup, AuthService){

$scope.name="asd";
  $scope.items = [];
  $scope.addItem = function (itemAmount, itemName, hospitalname) {
   $scope.items.push({
      amount: itemAmount,
      name: itemName,
...
.controller('formCtrl', function($scope, $state, $ionicPopup, AuthService){
